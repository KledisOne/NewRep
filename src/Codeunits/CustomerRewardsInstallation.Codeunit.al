codeunit 50100 "Customer Rewards Installation"
{
    ...
    // Chapter 5 - Lab 1-2
    // Added new procedures: OnInstallAppPerCompany, HandleFreshInstall, HandleReinstall, SetDefaultCustomerRewardsExtMgtCodeunit, 
    //InsertDefaultRewardLevels, InsertRewardLevel, InitializeRewardsForExistingCustomers
    Subtype = Install;
