codeunit 50101 "Customer Rewards Ext Mgt"
{
    ...
    // Chapter 5 - Lab 1-2
    // Added new procedures: IsCustomerRewardsActivated, OpenCustomerRewardsWizard, OpenRewardsLevelPage, GetRewardLevel, 
    //ActivateCustomerRewards, OnGetActivationCodeStatusFromServer, OnGetActivationCodeStatusFromServerSubscriber, 
    //GetHttpResponse, OnAfterReleaseSalesDocSubscriber, CanHandle
    // Added var DummySuccessResponseTxt, NoRewardlevelTxt
