table 50127 ExampleHeader
{
    ...
    // Chapter 5 - Lab 1-2
    // Added new fields: No., Document Date, No. Series, Posting Date, No. Printed
    //Added var ExampleSetup, NoSeriesManagement
    // Added code on trigger OnInsert
    //Added procedure AssistEdit, InitRecord
