page 50100 "Customer Rewards Wizard"
{
    ...
    // Chapter 5 - Lab 1-2
    // Added new fields:  Media Reference, Spacer1, EnableFeature,  ActionNext 
    //Add new action: ActionBack ,ActionActivate, ActionFinish
    //Added code on page trigger: OnInit, OnOpenPage
    //Added new procedures : 
    // EnableControls, NextStep, FinishAndEnableCustomerRewards, ShowFirstPage
    // , ShowSecondPage, ShowFinalPage, ResetControls, LoadTopBanners
    //Added new var : 
    // MediaRepositoryStandard, MediaResourcesStandard, Step, ActivationCode
    // , TopBannerVisible, FirstPageVisible, SecondPageVisible, FinalPageVisible,
    // FinishEnabled, BackEnabled, NextEnabled, ActivateEnabled, EnableCustomerRewards
